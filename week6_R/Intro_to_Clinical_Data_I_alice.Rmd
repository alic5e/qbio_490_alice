...
```{r}
write.csv(clinic, "/Users/aliceeeee/Desktop/Spring23/QBIO490/qbio_490_alice/analysis_data/brca_clinical_data.csv", row.names=FALSE)
```
...
plot(x=clinic$age_at_initial_pathologic_diagnosis,
     y=clinic$lymph_node_examined_count,
     main = "Lymph Node Examined Count vs Age at Diagnosis",
     xlab = "Age at Disgnosis",
     ylab = "Lymph Node Examined Count")
```
...
```{r Exercise 4.2}
# create plot here
boxplot(formula=clinic$age_at_initial_pathologic_diagnosis~ clinic$gender,
        data=clinic,
        xlab="Gender",
        ylab="Age at Diagnosis",
        main="Age at Diagnosis vs Gender")
```
...
```{r}
under30_over60_mask <-ifelse(clinic$age_at_initial_pathologic_diagnosis>60|clinic$age_at_initial_pathologic_diagnosis<35,TRUE,FALSE)
```
