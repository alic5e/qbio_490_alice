...
write.csv(clinical, "/Users/aliceeeee/Desktop/Spring23/QBIO490/qbio_490_alice/analysis_data/brca_clinical_data.csv", row.names = FALSE)
```
...
The result is significant, showing a correlation between receptor and aliveness.
...
ggsave("/Users/aliceeeee/Desktop/Spring23/QBIO490/qbio_490_alice/week7_maf/oncoplot.png")
```
...
```{r Exercise 8.2}
oncoplot(maf = maf_object,
         genes = c('MUC16','TP53','RYR2','TTN','GATA3'),
         borderCol = NA)
```
...
ggsave("/Users/aliceeeee/Desktop/Spring23/QBIO490/qbio_490_alice/week7_maf/oncoplot_compare.png")
```
...
ggsave("/Users/aliceeeee/Desktop/Spring23/QBIO490/qbio_490_alice/week7_maf/lolliplot.png")
```
...
Yes, maybe it's the active domain
- What kinds of mutations are the most common?
missense mutation
- Are there any other interesting observations?
for both young and old patients, the location of highest mutation is the same.
...
The longer the time, the smaller survival rate, and it drops between 0 to 2000days.
What can you conclude from your plot?
Patients with mutant in TP53 gene have a slightly higher survival rate around 2000days.
